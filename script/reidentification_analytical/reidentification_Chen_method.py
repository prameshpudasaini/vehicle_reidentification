...
# =============================================================================
# Chen's method to reidentify vehicles
# =============================================================================
...
def computeReidMetrics():
    ...
    if eff_length_adv == 26: # calibrated effective vehicle length
        match_result.to_csv("ignore/reidentification_result_analytical/match_result_Chen_method.txt", sep = '\t', index = False)
...
metrics.to_csv("ignore/reidentification_result_analytical/metrics_Chen_method.txt", sep = '\t', index = False)